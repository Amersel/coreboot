...
static void ec_init(void)
{
	...
	static const struct ec_init_entry hwm_init_table[] = {
                {0x2fc, 0xa0}, {0x2fd, 0x32}, {0x5, 0x77}, {0x18, 0xf},
                {0x19, 0x7}, {0x1a, 0x2f}, {0x8a, 0x4d}, {0x8b, 0xba},
                {0x8c, 0x73}, {0xba, 0x10}, {0xd1, 0xff}, {0xd6, 0xff},
                {0xdb, 0xff}, {0x48, 0x0}, {0x49, 0x0}, {0x7a, 0x0},
                {0x7b, 0x0}, {0x7c, 0x0}, {0x80, 0x0}, {0x81, 0x0},
                {0x82, 0x0}, {0x83, 0xbb}, {0x84, 0xb0}, {0x1a1, 0x88},
                {0x1a4, 0x80}, {0x88, 0x0}, {0x89, 0x0}, {0xa0, 0x2},
                {0xa1, 0x2}, {0xa2, 0x2}, {0xa4, 0x4}, {0xa5, 0x4},
                {0xa6, 0x4}, {0xab, 0x0}, {0xad, 0x3f}, {0xb7, 0x7},
                {0x62, 0x50}, {0x63, 0x46}, {0x64, 0x50}, {0x65, 0x46},
                {0x66, 0x50}, {0x67, 0x46}, {0x57, 0xff}, {0x59, 0xff},
                {0x61, 0xff}, {0x1bc, 0x0}, {0x1bd, 0x0}, {0x1bb, 0x0},
                {0x85, 0x4b}, {0x86, 0x39}, {0x87, 0x11}, {0x90, 0x72},
                {0x91, 0x88}, {0x95, 0x86}, {0x96, 0xa9}, {0x97, 0xa9},
                {0x9b, 0xa9}, {0xae, 0xa4}, {0xaf, 0xa4}, {0xb3, 0xa4},
                {0xc4, 0xff}, {0xc5, 0xff}, {0xc9, 0xff}, {0x40, 0x1},
                {0x2fc, 0x0}, {0x2b3, 0x9a}, {0x2b4, 0x5}, {0x2cc, 0x1},
                {0x2d0, 0x4c}, {0x2d2, 0x1}, {0x2db, 0x1}, {0x6e, 0x7},
                {0x6f, 0x5}, {0x70, 0x5}, {0x71, 0x5}, {0x72, 0x5},
                {0x73, 0x7}, {0x74, 0x5}, {0x75, 0x5}, {0x18b, 0x3},
                {0x18c, 0x3}, {0x57, 0xff}, {0x59, 0xff}, {0x5b, 0xff},
                {0x5d, 0xff}, {0x5f, 0xff}, {0x61, 0xff}, {0x6e, 0x1},
                {0x6f, 0x3}, {0x70, 0x3}, {0x71, 0x3}, {0x72, 0x3},
                {0x73, 0x1}, {0x74, 0x3}, {0x75, 0x3}, {0x80, 0x0},
                {0x81, 0x0}, {0x82, 0x0}, {0x85, 0xf6}, {0x86, 0x36},
                {0x87, 0x11}, {0x90, 0x77}, {0x91, 0x92}, {0x92, 0x8b},
                {0x93, 0x92}, {0x94, 0x86}, {0x95, 0x86}, {0x96, 0xa9},
                {0x97, 0xa9}, {0x98, 0xa9}, {0x99, 0xa9}, {0x9a, 0xa9},
                {0x9b, 0xa9}, {0xa0, 0x6}, {0xa1, 0x18}, {0xa2, 0x20},
                {0xae, 0x9c}, {0xaf, 0x9c}, {0xb0, 0x9c}, {0xb1, 0x9c},
                {0xb2, 0xa4}, {0xb3, 0xa4}, {0xd1, 0xff}, {0xd6, 0xff},
                {0xdb, 0xff}, {0xea, 0x5c}, {0xeb, 0x5c}, {0x184, 0xff},
                {0x186, 0xff}, {0x1a6, 0x5e}, {0x1a7, 0x5e}, {0x1a8, 0xa9},
                {0x1a9, 0xa9}, {0x1ab, 0xa4}, {0x1ac, 0xa4}, {0x1bb, 0x8b},
                {0x1bc, 0x8b}, {0x1bd, 0x8b}, {0x1be, 0x8b}, {0x1bf, 0x8b},
                {0x1c0, 0x8b}, {0x1c1, 0x8b}, {0x1c2, 0x0},
	};
